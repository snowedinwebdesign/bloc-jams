var collectionItemTemplate =
  ...
  window.onload = function() {
    // At #1, we select the first (and only, as we've designed it) element with an album-covers class name. We assign this specified element to a variable named collectionContainer.
